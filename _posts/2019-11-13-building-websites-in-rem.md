...
If the font, declared on the root of your HTML element, has a font-size of 20px, a pixel in your site is 1/20th by 1/20th root ems big. Knowing this, you can now build your website the way you used to be. Even media queries can be defined in root ems. A larger font could have a font-size of 2 root ems (40px) and your body text could be 0.8 root em (16px).
