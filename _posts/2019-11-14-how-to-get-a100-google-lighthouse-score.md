...
Fortunately, there is a much simpler approach. You should simply use less Javascript and CSS. When you compare the websites built by Usecue to the website built by Delete Agency you see a difference in Javascript and CSS size of a factor 10. When you look at all websites worldwide, the difference is more than a factor 20, as the 'average website' is has [400kb Javascript](https://httparchive.org/reports/state-of-javascript#bytesJs) and [60kb CSS](https://httparchive.org/reports/page-weight#bytesCss). To achieve this difference I only had to do ONE thing: stop using (Javascript and CSS) frameworks. A relatively simple solution, which obviously completely removes the need for inlining or splitting code.
...
Not using Javascript and CSS frameworks might seem scary at first. But Javascript and CSS have come a long way. Things like Flexbox, CSS columns and CSS grid handle most of your more complex CSS problems with ease. If you feel insecure about programming non-jQuery stuff, please let [Chris Ferdinandy](https://gomakethings.com/) help you. He is an advocate for a simpler World Wide Web and loves to teach you [Vanilla Javascript](https://gomakethings.com/). Learn to write lean CSS and lean Javascript and fight website obesitas.