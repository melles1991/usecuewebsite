...
You might feel that it is nearly impossible to get to a perfect 100% score. You probably already minify your Javascript, properly scale your images and even combine some requests. Unfortunately, that did not help nearly enough. But you are doing it wrong. I build 100% scoring websites on a daily basis, so obviously it is very well possible to get a perfect score on all your websites with very little effort. Let me explain to do that too.

There are some basic things you just need to know when it comes to speed or performance. Minifying does not beat gzipping, image scaling does not beat JPG compression and combining requests actually counter-effective (over HTTP/2). This is probably the reason why your earlier efforts had little to no effect. Another important thing to know is that Google Lighthouse simulates a slow connection. This emphasizes the importance of a low 'page weight' or 'total size' over fast infrastructure, as a small page is delivered significantly faster over such a narrow connection than a large page.
