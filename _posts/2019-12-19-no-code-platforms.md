...
The things content creators create with these no-code platforms is often not very good from a developer and art director point of view. A focussed theme with a completely fixed design but nearly unlimited options could theoretically work well when you sell it in large numbers, but this approach is terribly expensive if you want something unique. Although WordPress themes like Avada hit the sweet spot between freedom and fixed style, they perform not too well. And although visual editors, like Gutenberg, balance this freedom also quite well, they are either (extremely) limited or have bad performance. For now a fixed and focussed theme in combination with a visual editor is the closest you can get to creating something beautiful. However, the end result will always be subpar in terms of design and code.
