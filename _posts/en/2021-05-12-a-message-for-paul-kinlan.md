...
- Google fonts should no longer be a hosted service (because it is leaking visitor data)
- Cloudflare website should be penalized in the search results (because it is leaking visitor data)
...
- The 8.8.8.8 DNS server should be discontinued (because it is leaking visitor data)
